...
public final class DynaCode {
	...
	public DynaCode(String compileClasspath, ClassLoader parentClassLoader) {
		...
		this.compileClasspath += ":" +
								...
								;
		this.compileClasspath += "/home/basti/Programmierung/workspace/de.unisiegen.informatik.bs.alvis.primitive.datatypes/src/:";
		this.compileClasspath += "/home/basti/Programmierung/workspace/de.unisiegen.informatik.bs.alvis.compiler/src/:";
