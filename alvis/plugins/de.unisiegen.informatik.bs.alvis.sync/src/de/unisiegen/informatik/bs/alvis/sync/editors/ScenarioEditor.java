...
public class ScenarioEditor extends EditorPart implements
	...
	public void createPartControl(Composite parent) {
		...
		final List primitivesList = new List(primitives, SWT.MULTI | SWT.V_SCROLL);
		final List semaphoresList = new List(semaphores, SWT.MULTI | SWT.V_SCROLL);
		final List conditionsList = new List(conditions, SWT.MULTI | SWT.V_SCROLL);
