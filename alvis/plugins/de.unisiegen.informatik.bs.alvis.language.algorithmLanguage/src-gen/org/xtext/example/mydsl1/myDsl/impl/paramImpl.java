 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.paramImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.xtext.example.mydsl1.myDsl.impl.paramImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class paramImpl extends MinimalEObjectImpl.Container implements param
{
    ...
    if (type != null && type.eIsProxy())
    {
      ...
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MyDslPackage.PARAM__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(declaration newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.PARAM__TYPE, oldType, type));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.PARAM__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.PARAM__TYPE:
        if (resolve) return getType();
        return basicGetType();
      case MyDslPackage.PARAM__NAME:
        return getName();
    }
