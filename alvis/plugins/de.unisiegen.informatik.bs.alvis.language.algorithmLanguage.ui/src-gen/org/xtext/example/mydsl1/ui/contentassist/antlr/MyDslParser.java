		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatementAccess().getGroup_5_4(), "rule__Statement__Group_5_4__0");
					...
					put(grammarAccess.getStatementAccess().getPostFixExpressionAssignment_2_1(), "rule__Statement__PostFixExpressionAssignment_2_1");
					put(grammarAccess.getStatementAccess().getAssignmentsAssignment_3_1(), "rule__Statement__AssignmentsAssignment_3_1");
					put(grammarAccess.getStatementAccess().getExprsAssignment_4_2(), "rule__Statement__ExprsAssignment_4_2");
					put(grammarAccess.getStatementAccess().getStatementsAssignment_5_3(), "rule__Statement__StatementsAssignment_5_3");
					put(grammarAccess.getStatementAccess().getStatementsAssignment_5_4_1(), "rule__Statement__StatementsAssignment_5_4_1");
					put(grammarAccess.getStatementAccess().getExprsAssignment_6_3(), "rule__Statement__ExprsAssignment_6_3");
					put(grammarAccess.getStatementAccess().getStatementsAssignment_6_5(), "rule__Statement__StatementsAssignment_6_5");
					put(grammarAccess.getStatementAccess().getStatementsAssignment_7_3(), "rule__Statement__StatementsAssignment_7_3");
					put(grammarAccess.getFunctionCallAccess().getFunctionAssignment_0(), "rule__FunctionCall__FunctionAssignment_0");
					put(grammarAccess.getFunctionCallAccess().getExprsAssignment_2_0(), "rule__FunctionCall__ExprsAssignment_2_0");
