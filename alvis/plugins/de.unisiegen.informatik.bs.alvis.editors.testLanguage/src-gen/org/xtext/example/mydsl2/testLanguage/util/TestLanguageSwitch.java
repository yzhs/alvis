 ...
 */
package org.xtext.example.mydsl2.testLanguage.util;
 ...
 * <!-- end-user-doc -->
 * @see org.xtext.example.mydsl2.testLanguage.TestLanguagePackage
 * @generated
 */
public class TestLanguageSwitch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case TestLanguagePackage.DATATYPE:
      {
      ...
      case TestLanguagePackage.ENTITY:
      {
      ...
      case TestLanguagePackage.FEATURE:
      {
