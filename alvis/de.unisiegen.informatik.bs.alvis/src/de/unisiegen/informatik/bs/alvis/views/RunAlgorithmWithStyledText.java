 ...
 * 
 */
public class RunAlgorithmWithStyledText extends ViewPart implements PropertyChangeListener {
	 ...
	 * 
	 */
	public RunAlgorithmWithStyledText() {
	...
	public void createPartControl(Composite parent) {
		...
		try {
			...
			if (editor.getClass().getSimpleName().equals("XtextEditor")) {
				...
				text.setFont(new Font(null, "Courier New", 14, SWT.NORMAL));
