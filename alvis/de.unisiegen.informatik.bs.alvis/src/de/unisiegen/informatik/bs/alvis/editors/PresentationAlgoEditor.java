...
import de.unisiegen.informatik.bs.alvis.views.Algorithm;
import de.unisiegen.informatik.bs.alvis.views.AutoCompletion;

/**
 * @author simon
 *
 */
public class PresentationAlgoEditor extends EditorPart {
	...
	public void init(IEditorSite site, IEditorInput input)
		...
		String filename = ((FileEditorInput)input).getPath().toString();
		
		String algorithm = (String)IO.deserialize(filename);
